...
import AnimationRevealPage from "helpers/AnimationRevealPage.js";
import caravan2 from "../images/activities_images/caravan3.jpg";
import caravan3 from "../images/activities_images/caravan2.jpg";
...
export default () => {
  const cards = [
...

    {
      ...
      description:
        "Nous sommes reconnaissants envers La charité des bienfaiteurs qui permet d'offrir chaleur et réconfort aux familles défavorisées chaque hiver, créant ainsi une expérience mémorable. à faire une différence dans la vie des gens.",
      // url: "https://timerse.com"
    }
  ];
